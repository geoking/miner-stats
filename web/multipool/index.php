	...
	<div class="container">
		...
		<div class="col-md-4">
			<ul class="list-group">
				...
				<li class="list-group-item">&Xi; Est Month		<span class="pull-right">&Xi;<?=number_format(($stat['todayEstimated']*365)/12,5)?> (<?=$fiat['sym'].number_format(($ethtofiat * ($stat['todayEstimated']*365)/12),2)?>)</span></li>
				<li class="list-group-item">&Xi; Est Year		<span class="pull-right">&Xi;<?=number_format($stat['todayEstimated']*365,5)?> (<?=$fiat['sym'].number_format(($ethtofiat * $stat['todayEstimated']*365),2)?>)</span></li>
			</ul>
		</div>
